...
//enclave_db.cpp
extern void decryptMessage(char *encMessageIn, size_t len, char *decMessageOut, size_t lenOut);
extern void encryptMessage(char *decMessageIn, size_t len, char *encMessageOut, size_t lenOut);
